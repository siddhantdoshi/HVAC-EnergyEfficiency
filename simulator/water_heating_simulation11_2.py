...
np.savetxt("qtable_multistate_11_2_" + filename_suffix +
...
# plt.show()
plt.savefig('final_training11_2_' + filename_suffix + '.png')
plt.clf()


plt.plot(np.arange(0, len(test_temp)), test_temp)
# plt.show()
plt.savefig('simulation11_2_' + filename_suffix + '.png')

print(final_actions)
# np.savetxt("final_actions_9.csv", final_actions, delimiter=",")

with open('final_actions_11_2_' + filename_suffix + '.txt', 'w') as f:
